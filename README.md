...
## Content Moderation
This is to borrow heavily from karl Popper's Paradox of Tolerance. A global governance problem, which is that it's impossible to make a set of governance rules that a billion people can agree to. This is to counter reach and torelence 
